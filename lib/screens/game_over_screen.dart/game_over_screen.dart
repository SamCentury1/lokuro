...
import 'package:lokuro/screens/game_over_screen.dart/components/coins_collected_widget.dart';
...
class _GameOverScreenState extends State<GameOverScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String,dynamic>> gemSummaryTableData = getGemSummaryTableData(gamePlayState);
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            CoinsCollectedWidget(
              gamePlayState: gamePlayState, 
              gemSummaryTableData: gemSummaryTableData
            ),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: getSummaryTable(gamePlayState,gemSummaryTableData),
                ),
              ),
            )
...
List<Widget> getSummaryTable(GamePlayState gamePlayState, List<Map<String,dynamic>> gemSummaryTableData) {
  ...
  for (int i=0; i<gemSummaryTableData.length; i++) {
    Widget row = GameSummaryRow(index: i, gemData: gemSummaryTableData[i],);
    table.add(row);
  }
